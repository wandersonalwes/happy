...
export default function OrphanageDetails() {
  ...
  function handleOpenGoogleMapRoutes() {
    return Linking.openURL(`https://www.google.com/maps/search/?api=1&query=${orphanage?.latitude},${orphanage?.longitude}`)
  }
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.detailsContainer}>
        ...
        <View style={styles.mapContainer}>
          ...
          <RectButton opPress={handleOpenGoogleMapRoutes} style={styles.routesContainer}>
